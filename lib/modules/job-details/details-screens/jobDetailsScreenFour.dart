...
class JobDetailsScreenFour extends GetView<JobDetailsController> {
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          children: [
                            CustomText(
                              text: controller.jobDetails.value?.company.name ?? 'N/A',
                            ...
                            CustomText(
                              text: controller.jobDetails.value?.company.location ?? 'N/A',
                              color: primaryBlackColor,
                              fontSize: 18.0,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: CustomText(
                              text: controller.jobDetails.value?.company.aboutUs ?? 'N/A',
                              color: primaryBlackColor,
                              fontSize: 16.0,
                            ),
                          ),
