...
class CourseFilterScreen extends GetView<CourseFilterController> {
          ...
          child: Column(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                ...
                CustomSelectMultiDropdown(
                  controller: controller,
                  title: 'course filter location'.tr,
                  text: 'click here to select course location'.tr,
                  onPressed: () {
                ...
                CustomElevatedButton(
                        onPressed: (){
                          ...
                          Get.toNamed('/filterDisplayCourse');
                        },
