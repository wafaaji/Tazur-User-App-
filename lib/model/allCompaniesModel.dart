...
AllCompaniesModel allCompaniesModelFromJson(String str) => AllCompaniesModel.fromJson(json.decode(str));

String allCompaniesModelToJson(AllCompaniesModel data) => json.encode(data.toJson());
